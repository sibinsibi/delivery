          ...
          <div class="row justify-content-between align-items-center">
            ...
            <div class="app-utilities col-auto">
              ...
              <div class="app-utility-item">
                <a onclick="location.reload();" title="Settings">
                  <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                  <svg
                    width="1em"
                    height="1em"
          ...
          <ul class="app-menu list-unstyled accordion" id="menu-accordion">
              ...
              >
                <ul class="submenu-list list-unstyled">
                  <li class="submenu-item">
                    <router-link class="submenu-link" to="/current_orders"
            ...
            <li class="nav-item has-submenu">
              ...
              >
                <ul class="submenu-list list-unstyled">
                  <li class="submenu-item">
                    <router-link class="submenu-link" to="/add_shop"
                      >Add Shop</router-link
                    >
                  </li>
                  <li class="submenu-item">
                    <router-link class="submenu-link" to="/shops"
            ...
            <li class="nav-item has-submenu">
              ...
              >
                <ul class="submenu-list list-unstyled">
                  <li class="submenu-item">
                    <router-link class="submenu-link" to="/add_item"
                      >Add Item</router-link
                    >
                  </li>
                  <li class="submenu-item">
                    <router-link class="submenu-link" to="/get_item"
            ...
            <li class="nav-item has-submenu">
              ...
              >
                <span class="nav-icon">
                  <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                  <svg
                    class="svg-icon svg-icon bi bi-columns-gap"
                    viewBox="0 0 20 20"
                  >
                    <path
              ...
              <div
                id="submenu-6"
                class="collapse submenu submenu-6"
                data-bs-parent="#menu-accordion"
              >
                <ul class="submenu-list list-unstyled">
                  <li class="submenu-item">
                    <router-link class="submenu-link" to="/customers"
            ...
            <li class="nav-item has-submenu">
              ...
              >
                <span class="nav-icon">
                  <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                  <svg
                    class="svg-icon svg-icon bi bi-chevron-down"
                    viewBox="0 0 20 20"
                  >
                    <path
              ...
              <div
                id="submenu-7"
                class="collapse submenu submenu-7"
                data-bs-parent="#menu-accordion"
              >
                <ul class="submenu-list list-unstyled">
                  <li class="submenu-item">
                    <router-link class="submenu-link" to="/users"
