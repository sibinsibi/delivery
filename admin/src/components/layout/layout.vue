              ...
              >
                <ul class="submenu-list list-unstyled">
                  <li class="submenu-item">
                    <router-link class="submenu-link" to="/add_role"
                      >Add Role</router-link
                    >
                  </li>
                  <li class="submenu-item">
                    <router-link class="submenu-link" to="/add_permission"
                      >Add Permission</router-link
                    >
                  </li>
                  <li class="submenu-item">
                    <router-link class="submenu-link" to="/assign_user"
                      >Assign User</router-link
                    >
                  </li>
                </ul>
              </div>
